...
export function AdminBlogsClient({ initialBlogs }: { initialBlogs: Blog[] }) {
  ...
  const blogTemplateSampleData = [
    ...
    },
    {
      ...
      seccion_1_nivel: "H2",
      seccion_1_titulo: "1. Integración Estética en Techos Continuos",
      seccion_1_contenido: "Las soluciones ocultas eliminan marcos visibles permitiendo una línea de impulsión limpia en techos de yeso laminado.",
      seccion_2_nivel: "H3",
      seccion_2_titulo: "1.1 Fijación Mediante Clips Ocultos",
      seccion_2_contenido: "El sistema de clipaje rápido facilita el montaje y el mantenimiento posterior sin dañar la pintura circundante.",
      seccion_3_nivel: "H2",
      seccion_3_titulo: "2. Comportamiento Acústico y Aerodinámico",
      seccion_3_contenido: "El diseño del deflector interno minimiza la turbulencia garantizando niveles sonoros por debajo de 22 dB(A).",
      seccion_4_nivel: "",
      seccion_4_titulo: "",
      seccion_4_contenido: "",
