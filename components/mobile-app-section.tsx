    ...
    <section className="bg-gradient-to-br from-gray-50 to-white py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="mb-4 text-chart-3 font-bold text-4xl md:text-6xl text-center">MYSAir App</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-center text-lg md:text-xl">
            Controla tu sistema de climatización desde cualquier lugar con nuestra aplicación móvil intuitiva y potente
          </p>
        </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Control Remoto</h3>
                  <p className="text-sm text-gray-600">Ajusta temperatura, velocidad y modo desde cualquier lugar</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Monitoreo 24/7</h3>
                  <p className="text-sm text-gray-600">
                    Supervisa el estado y rendimiento de tu sistema en tiempo real
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Programación</h3>
                  <p className="text-sm text-gray-600">Crea horarios personalizados para máximo confort y eficiencia</p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Configuración Avanzada</h3>
                  <p className="text-sm text-gray-600">Personaliza cada aspecto según tus preferencias específicas</p>
                </CardContent>
              </Card>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs lg:text-sm font-extralight">Disponible en</div>
