  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Política de Cookies (UE)</h1>
        <p className="text-gray-600 mb-8">Última actualización: 28 de febrero de 2024</p>

        <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">1. Introducción</h2>
            <p>
              Nuestra web, <a href="https://mysair.es" className="text-blue-600 hover:text-blue-800">https://mysair.es</a> (en adelante: «la web») utiliza cookies y otras tecnologías relacionadas (para mayor comodidad, todas las tecnologías se denominan «cookies»). Las cookies también son colocadas por terceros a los que hemos contratado. En el siguiente documento te informamos sobre el uso de cookies en nuestra web.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">2. ¿Qué son las cookies?</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. ¿Qué son los scripts?</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">4. ¿Qué es una baliza web?</h2>
            <p>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.1 Cookies técnicas o funcionales</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.2 Cookies de estadísticas</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.3 Cookies de marketing/seguimiento</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.4 Redes sociales</h3>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">7. Consentimiento</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">8. Activación/desactivación y borrado de cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">9. Tus derechos con respecto a los datos personales</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">10. Datos de contacto</h2>
            <p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg mt-4">
              <p>
                <strong>Materiales y Soportes Ind. del Levante S.L.U</strong>
                <br />
                Calle Mayor, 27 – 30149, El Siscar – Santomera – Murcia
                <br />
                España
                <br />
                <strong>Web:</strong> <a href="https://mysair.es" className="text-blue-600 hover:text-blue-800">https://mysair.es</a>
                <br />
                <strong>Correo electrónico:</strong> agfri@agfri.com
                <br />
                <strong>Número de teléfono:</strong> 966744473
              </p>
            </div>
          </section>
          ...
          <section className="mt-8 pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-600">
              Esta política de cookies se ha sincronizado con cookiedatabase.org el septiembre 28, 2021.
            </p>
          </section>
        </div>
      </div>
